...
- Creator: $9/mo or launch pack, 12 video credits
- Studio: $19/mo or launch pack, 32 video credits
- Pro: $49/mo or launch pack, 100 video credits

Implemented launch contract:

1. Create one Stripe product: `NorthStar Studio`.
2. Create three active prices matching the packs above.
3. Store the price ids in `STRIPE_PRICE_9`, `STRIPE_PRICE_19`, and `STRIPE_PRICE_49`.
